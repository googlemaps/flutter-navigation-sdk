...
data class MapOptionsDto (
  ...
  companion object {
    ...
    fun fromList(list: List<Any?>): MapOptionsDto {
      ...
      return MapOptionsDto(cameraPosition, mapType, compassEnabled, rotateGesturesEnabled, scrollGesturesEnabled, tiltGesturesEnabled, zoomGesturesEnabled, scrollGesturesEnabledDuringRotateOrZoom, mapToolbarEnabled, minZoomPreference, maxZoomPreference, zoomControlsEnabled, cameraTargetBounds)
    }
  }
  fun toList(): List<Any?> {
    return listOf<Any?>(
...
interface MapViewApi {
  ...
  companion object {
    ...
    fun setUp(binaryMessenger: BinaryMessenger, api: MapViewApi?) {
      ...
      run {
        val channel = BasicMessageChannel<Any?>(binaryMessenger, "dev.flutter.pigeon.google_navigation_flutter.MapViewApi.registerOnCameraChangedListener", codec)
        if (api != null) {
          channel.setMessageHandler { message, reply ->
            val args = message as List<Any?>
            val viewIdArg = args[0].let { if (it is Int) it.toLong() else it as Long }
...
interface NavigationSessionApi {
  /** General. */
  fun createNavigationSession(abnormalTerminationReportingEnabled: Boolean, callback: (Result<Unit>) -> Unit)
      ...
      run {
        ...
        if (api != null) {
          channel.setMessageHandler { message, reply ->
            ...
            api.createNavigationSession(abnormalTerminationReportingEnabledArg) { result: Result<Unit> ->
              val error = result.exceptionOrNull()
              if (error != null) {
                reply.reply(wrapError(error))
              } else {
...
interface AutoMapViewApi {
  ...
  companion object {
    ...
    fun setUp(binaryMessenger: BinaryMessenger, api: AutoMapViewApi?) {
      run {
        val channel = BasicMessageChannel<Any?>(binaryMessenger, "dev.flutter.pigeon.google_navigation_flutter.AutoMapViewApi.awaitMapReady", codec)
        if (api != null) {
          channel.setMessageHandler { _, reply ->
      ...
      run {
        val channel = BasicMessageChannel<Any?>(binaryMessenger, "dev.flutter.pigeon.google_navigation_flutter.AutoMapViewApi.registerOnCameraChangedListener", codec)
        if (api != null) {
          channel.setMessageHandler { _, reply ->
            var wrapped: List<Any?>
            try {
