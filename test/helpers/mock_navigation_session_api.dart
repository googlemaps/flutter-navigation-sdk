...
///
/// This class extends NavigationSessionAPIImpl and overrides ensureSessionAPISetUp
/// to create an internal instance of NavigationSessionEventApiImpl instead of
...
class TestNavigationSessionAPIImpl extends NavigationSessionAPIImpl {
  late NavigationSessionEventApiImpl _testEventApi;
  ...
  void ensureSessionAPISetUp() {
    ...
    _testEventApi = NavigationSessionEventApiImpl(
      sessionEventStreamController: sessionEventStreamControllerForTesting,
    );
  }
}
