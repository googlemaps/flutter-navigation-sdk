...
abstract class TestNavigationSessionApi {
  ...
  Future<void> createNavigationSession(bool abnormalTerminationReportingEnabled, TaskRemovedBehaviorDto behavior, NavigationNotificationOptionsDto? notificationOptions);
    ...
    messageChannelSuffix = messageChannelSuffix.isNotEmpty ? '.$messageChannelSuffix' : '';
    {
      ...
      if (api == null) {
        ...
        _testBinaryMessengerBinding!.defaultBinaryMessenger.setMockDecodedMessageHandler<Object?>(pigeonVar_channel, (Object? message) async {
          ...
          final NavigationNotificationOptionsDto? arg_notificationOptions = (args[2] as NavigationNotificationOptionsDto?);
          try {
            await api.createNavigationSession(arg_abnormalTerminationReportingEnabled!, arg_behavior!, arg_notificationOptions);
            return wrapResponse(empty: true);
          } on PlatformException catch (e) {
            return wrapResponse(error: e);
          }          catch (e) {
