...
private class _NavigationViewCreationApiCodecReaderWriter: FlutterStandardReaderWriter {
  override func reader(with data: Data) -> FlutterStandardReader {
    return _NavigationViewCreationApiCodecReader(data: data)
  }

  override func writer(with data: NSMutableData) -> FlutterStandardWriter {
    return _NavigationViewCreationApiCodecWriter(data: data)
  }
}

class _NavigationViewCreationApiCodec: FlutterStandardMessageCodec {
  static let shared = _NavigationViewCreationApiCodec(readerWriter: _NavigationViewCreationApiCodecReaderWriter())
}
...
class _NavigationViewCreationApiSetup {
  ...
  /// Sets up an instance of `_NavigationViewCreationApi` to handle messages through the `binaryMessenger`.
  static func setUp(binaryMessenger: FlutterBinaryMessenger, api: _NavigationViewCreationApi?) {
    let _createChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.google_navigation_flutter._NavigationViewCreationApi._create", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
