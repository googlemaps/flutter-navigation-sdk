...
class MapViewApiSetup {
  ...
  static func setUp(binaryMessenger: FlutterBinaryMessenger, api: MapViewApi?) {
    ...
    let registerOnCameraChangedListenerChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.google_navigation_flutter.MapViewApi.registerOnCameraChangedListener", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
...
protocol NavigationSessionApi {
  /// General.
  func createNavigationSession(abnormalTerminationReportingEnabled: Bool, completion: @escaping (Result<Void, Error>) -> Void)
  ...
  static func setUp(binaryMessenger: FlutterBinaryMessenger, api: NavigationSessionApi?) {
    ...
    if let api = api {
      createNavigationSessionChannel.setMessageHandler { message, reply in
        ...
        api.createNavigationSession(abnormalTerminationReportingEnabled: abnormalTerminationReportingEnabledArg) { result in
          switch result {
            case .success:
              reply(wrapResult(nil))
            case .failure(let error):
...
class AutoMapViewApiSetup {
  ...
  static func setUp(binaryMessenger: FlutterBinaryMessenger, api: AutoMapViewApi?) {
    let awaitMapReadyChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.google_navigation_flutter.AutoMapViewApi.awaitMapReady", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    let registerOnCameraChangedListenerChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.google_navigation_flutter.AutoMapViewApi.registerOnCameraChangedListener", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
