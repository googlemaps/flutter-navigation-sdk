...
///
/// Generated class from Pigeon that represents data sent in messages.
struct NavigationCustomNotificationOptionsDto: Hashable {
  var channelId: String
  var title: String
  var body: String
  var smallIconResourceName: String? = nil
  var color: Int64? = nil
  var resumeAppOnTap: Bool


  // swift-format-ignore: AlwaysUseLowerCamelCase
  static func fromList(_ pigeonVar_list: [Any?]) -> NavigationCustomNotificationOptionsDto? {
    let channelId = pigeonVar_list[0] as! String
    let title = pigeonVar_list[1] as! String
    let body = pigeonVar_list[2] as! String
    let smallIconResourceName: String? = nilOrValue(pigeonVar_list[3])
    let color: Int64? = nilOrValue(pigeonVar_list[4])
    let resumeAppOnTap = pigeonVar_list[5] as! Bool

    return NavigationCustomNotificationOptionsDto(
      channelId: channelId,
      title: title,
      body: body,
  ...
  static func == (lhs: NavigationCustomNotificationOptionsDto, rhs: NavigationCustomNotificationOptionsDto) -> Bool {
    return deepEqualsmessages(lhs.toList(), rhs.toList())  }
  func hash(into hasher: inout Hasher) {
    deepHashmessages(value: toList(), hasher: &hasher)
  }
...
struct NavigationNotificationOptionsDto: Hashable {
  ...
  var resumeAppOnTap: Bool
  var customNotificationOptions: NavigationCustomNotificationOptionsDto? = nil
  ...
  static func fromList(_ pigeonVar_list: [Any?]) -> NavigationNotificationOptionsDto? {
    ...
    let customNotificationOptions: NavigationCustomNotificationOptionsDto? = nilOrValue(pigeonVar_list[3])

    return NavigationNotificationOptionsDto(
      notificationId: notificationId,
      defaultMessage: defaultMessage,
      resumeAppOnTap: resumeAppOnTap,
      customNotificationOptions: customNotificationOptions
    )
  }
  func toList() -> [Any?] {
    return [
...
private class MessagesPigeonCodecReader: FlutterStandardReader {
  override func readValue(ofType type: UInt8) -> Any? {
    ...
    case 203:
      return NavigationCustomNotificationOptionsDto.fromList(self.readValue() as! [Any?])
    case 204:
...
private class MessagesPigeonCodecWriter: FlutterStandardWriter {
  override func writeValue(_ value: Any) {
    if let value = value as? MapViewTypeDto {
      ...
      super.writeByte(202)
      super.writeValue(value.toList())
    } else if let value = value as? NavigationCustomNotificationOptionsDto {
      super.writeByte(203)
      super.writeValue(value.toList())
