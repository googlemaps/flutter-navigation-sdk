...
class NavigationCustomNotificationOptionsDto {
  ...
  static NavigationCustomNotificationOptionsDto decode(Object result) {
    result as List<Object?>;
    return NavigationCustomNotificationOptionsDto(
      channelId: result[0]! as String,
      title: result[1]! as String,
      body: result[2]! as String,
      smallIconResourceName: result[3] as String?,
      color: result[4] as int?,
      resumeAppOnTap: result[5]! as bool,
    );
  }
  ...
  // ignore: avoid_equals_and_hash_code_on_mutable_classes
  bool operator ==(Object other) {
    if (other is! NavigationCustomNotificationOptionsDto || other.runtimeType != runtimeType) {
      return false;
    }
    if (identical(this, other)) {
      return true;
...
class NavigationNotificationOptionsDto {
  ...
  NavigationCustomNotificationOptionsDto? customNotificationOptions;
  ...
  static NavigationNotificationOptionsDto decode(Object result) {
    ...
    return NavigationNotificationOptionsDto(
      ...
      customNotificationOptions: result[3] as NavigationCustomNotificationOptionsDto?,
    );
  }
  ...
  // ignore: avoid_equals_and_hash_code_on_mutable_classes
  bool operator ==(Object other) {
    if (other is! NavigationNotificationOptionsDto || other.runtimeType != runtimeType) {
      return false;
    }
    if (identical(this, other)) {
      return true;
...
class _PigeonCodec extends StandardMessageCodec {
  ...
  void writeValue(WriteBuffer buffer, Object? value) {
    if (value is int) {
      ...
      buffer.putUint8(202);
      writeValue(buffer, value.encode());
    }    else if (value is NavigationCustomNotificationOptionsDto) {
      buffer.putUint8(203);
      writeValue(buffer, value.encode());
  ...
  Object? readValueOfType(int type, ReadBuffer buffer) {
    switch (type) {
      ...
      case 203:
        return NavigationCustomNotificationOptionsDto.decode(readValue(buffer)!);
      case 204:
...
class NavigationSessionApi {
  ...
  Future<void> createNavigationSession(bool abnormalTerminationReportingEnabled, TaskRemovedBehaviorDto behavior, NavigationNotificationOptionsDto? notificationOptions) async {
    ...
    final Future<Object?> pigeonVar_sendFuture = pigeonVar_channel.send(<Object?>[abnormalTerminationReportingEnabled, behavior, notificationOptions]);
    final List<Object?>? pigeonVar_replyList =
        await pigeonVar_sendFuture as List<Object?>?;
    if (pigeonVar_replyList == null) {
      throw _createConnectionError(pigeonVar_channelName);
