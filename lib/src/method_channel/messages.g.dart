...
class MarkerOptionsDto {
  ...
  static MarkerOptionsDto decode(Object result) {
    ...
    return MarkerOptionsDto(
      ...
      clusterManagerId: result[11] as String?,
    );
  }
...
class ClusterManagerDto {
  ...
  List<Object?> _toList() {
    return <Object?>[clusterManagerId];
  }
  ...
  static ClusterManagerDto decode(Object result) {
    result as List<Object?>;
    return ClusterManagerDto(clusterManagerId: result[0]! as String);
  }

  @override
  // ignore: avoid_equals_and_hash_code_on_mutable_classes
  bool operator ==(Object other) {
    if (other is! ClusterManagerDto || other.runtimeType != runtimeType) {
      return false;
    }
    if (identical(this, other)) {
      return true;
...
class ClusterDto {
  ...
  List<Object?> _toList() {
    return <Object?>[clusterManagerId, position, markerIds];
  }
  ...
  static ClusterDto decode(Object result) {
    result as List<Object?>;
    return ClusterDto(
      clusterManagerId: result[0]! as String,
      position: result[1]! as LatLngDto,
      markerIds: (result[2] as List<Object?>?)!.cast<String>(),
    );
  }
  ...
  // ignore: avoid_equals_and_hash_code_on_mutable_classes
  bool operator ==(Object other) {
    if (other is! ClusterDto || other.runtimeType != runtimeType) {
      return false;
    }
    if (identical(this, other)) {
      return true;
...
class _PigeonCodec extends StandardMessageCodec {
  ...
  void writeValue(WriteBuffer buffer, Object? value) {
    if (value is int) {
      ...
      buffer.putUint8(137);
      writeValue(buffer, value.index);
    } else if (value is ClusterEventTypeDto) {
      buffer.putUint8(138);
      writeValue(buffer, value.index);
      ...
      buffer.putUint8(164);
      writeValue(buffer, value.encode());
    } else if (value is ClusterManagerDto) {
      buffer.putUint8(165);
      writeValue(buffer, value.encode());
    } else if (value is ClusterDto) {
      buffer.putUint8(166);
      writeValue(buffer, value.encode());
  ...
  Object? readValueOfType(int type, ReadBuffer buffer) {
    switch (type) {
      ...
      case 138:
        final int? value = readValue(buffer) as int?;
        return value == null ? null : ClusterEventTypeDto.values[value];
      case 139:
        final int? value = readValue(buffer) as int?;
      ...
      case 165:
        return ClusterManagerDto.decode(readValue(buffer)!);
      case 166:
        return ClusterDto.decode(readValue(buffer)!);
      case 167:
...
class MapViewApi {
  ...
  Future<List<ClusterManagerDto>> getClusterManagers(int viewId) async {
    final String pigeonVar_channelName =
        'dev.flutter.pigeon.google_navigation_flutter.MapViewApi.getClusterManagers$pigeonVar_messageChannelSuffix';
    final BasicMessageChannel<Object?> pigeonVar_channel =
        BasicMessageChannel<Object?>(
          pigeonVar_channelName,
          pigeonChannelCodec,
    ...
    if (pigeonVar_replyList == null) {
      ...
      return (pigeonVar_replyList[0] as List<Object?>?)!
          .cast<ClusterManagerDto>();
    }
  }

  Future<List<ClusterManagerDto>> addClusterManagers(
    int viewId,
    List<ClusterManagerDto> clusterManagers,
  ) async {
    final String pigeonVar_channelName =
        'dev.flutter.pigeon.google_navigation_flutter.MapViewApi.addClusterManagers$pigeonVar_messageChannelSuffix';
    final BasicMessageChannel<Object?> pigeonVar_channel =
        BasicMessageChannel<Object?>(
          pigeonVar_channelName,
          pigeonChannelCodec,
  ...
  Future<void> removeClusterManagers(
    ...
    final String pigeonVar_channelName =
        'dev.flutter.pigeon.google_navigation_flutter.MapViewApi.removeClusterManagers$pigeonVar_messageChannelSuffix';
    final BasicMessageChannel<Object?> pigeonVar_channel =
        BasicMessageChannel<Object?>(
          pigeonVar_channelName,
          pigeonChannelCodec,
  ...
  Future<void> clearClusterManagers(int viewId) async {
    final String pigeonVar_channelName =
        'dev.flutter.pigeon.google_navigation_flutter.MapViewApi.clearClusterManagers$pigeonVar_messageChannelSuffix';
    final BasicMessageChannel<Object?> pigeonVar_channel =
        BasicMessageChannel<Object?>(
          pigeonVar_channelName,
          pigeonChannelCodec,
    ...
    }
    {
      ...
      if (api == null) {
        ...
        pigeonVar_channel.setMessageHandler((Object? message) async {
          assert(
            message != null,
            'Argument for dev.flutter.pigeon.google_navigation_flutter.ViewEventApi.onClusterEvent was null.',
          );
          final List<Object?> args = (message as List<Object?>?)!;
          final int? arg_viewId = (args[0] as int?);
          assert(
            arg_viewId != null,
            'Argument for dev.flutter.pigeon.google_navigation_flutter.ViewEventApi.onClusterEvent was null, expected non-null int.',
          );
          final String? arg_clusterManagerId = (args[1] as String?);
          assert(
            arg_clusterManagerId != null,
            'Argument for dev.flutter.pigeon.google_navigation_flutter.ViewEventApi.onClusterEvent was null, expected non-null String.',
          );
          final ClusterEventTypeDto? arg_eventType =
              (args[2] as ClusterEventTypeDto?);
          assert(
            arg_eventType != null,
            'Argument for dev.flutter.pigeon.google_navigation_flutter.ViewEventApi.onClusterEvent was null, expected non-null ClusterEventTypeDto.',
          );
          final ClusterDto? arg_cluster = (args[3] as ClusterDto?);
          assert(
            arg_cluster != null,
            'Argument for dev.flutter.pigeon.google_navigation_flutter.ViewEventApi.onClusterEvent was null, expected non-null ClusterDto.',
          );
          try {
            api.onClusterEvent(
              arg_viewId!,
              arg_clusterManagerId!,
              arg_eventType!,
              arg_cluster!,
            );
            return wrapResponse(empty: true);
