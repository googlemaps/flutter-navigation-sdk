...
class MapViewApi {
  ...
  Future<void> registerOnCameraChangedListener(int viewId) async {
    const String __pigeon_channelName = 'dev.flutter.pigeon.google_navigation_flutter.MapViewApi.registerOnCameraChangedListener';
    final BasicMessageChannel<Object?> __pigeon_channel = BasicMessageChannel<Object?>(
      __pigeon_channelName,
      pigeonChannelCodec,
      binaryMessenger: __pigeon_binaryMessenger,
...
class NavigationSessionApi {
  ...
  /// General.
  Future<void> createNavigationSession(bool abnormalTerminationReportingEnabled) async {
    ...
    final List<Object?>? __pigeon_replyList =
        await __pigeon_channel.send(<Object?>[abnormalTerminationReportingEnabled]) as List<Object?>?;
    if (__pigeon_replyList == null) {
      throw _createConnectionError(__pigeon_channelName);
    } else if (__pigeon_replyList.length > 1) {
      throw PlatformException(
...
class AutoMapViewApi {
  ...
  Future<void> awaitMapReady() async {
    const String __pigeon_channelName = 'dev.flutter.pigeon.google_navigation_flutter.AutoMapViewApi.awaitMapReady';
    final BasicMessageChannel<Object?> __pigeon_channel = BasicMessageChannel<Object?>(
      __pigeon_channelName,
      pigeonChannelCodec,
      binaryMessenger: __pigeon_binaryMessenger,
  ...
  Future<void> registerOnCameraChangedListener() async {
    const String __pigeon_channelName = 'dev.flutter.pigeon.google_navigation_flutter.AutoMapViewApi.registerOnCameraChangedListener';
    final BasicMessageChannel<Object?> __pigeon_channel = BasicMessageChannel<Object?>(
      __pigeon_channelName,
      pigeonChannelCodec,
      binaryMessenger: __pigeon_binaryMessenger,
