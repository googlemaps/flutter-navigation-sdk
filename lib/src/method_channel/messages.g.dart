...
class _NavigationViewCreationApi {
  ...
  static const MessageCodec<Object?> pigeonChannelCodec = __NavigationViewCreationApiCodec();

  Future<void> _create(ViewCreationOptionsDto msg) async {
    const String __pigeon_channelName = 'dev.flutter.pigeon.google_navigation_flutter._NavigationViewCreationApi._create';
